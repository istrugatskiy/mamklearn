...
export class about extends text_content {
    render() {
        return html`
            ...
            <p>
                Mamklearn is a quiz/learning app which puts security, ease of use, fun, and animation first. Our app uses sign in with google to ensure that students sign in with their school accounts. Mamklearn allows students and teachers to create
                their own player avatar, so that they can express themselves without usernames. Mamklearn is also designed with ease of use and animation in mind. The app has been tested with a wide variety of users with varying computer skill
                levels. As well as this, almost everything has an animation, something we are extremely proud of.
            </p>
