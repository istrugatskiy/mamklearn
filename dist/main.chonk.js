...
/* harmony export */   "contentEditableUpdate": () => (/* binding */ contentEditableUpdate),
/* harmony export */   "goBack": () => (/* binding */ goBack),
/* harmony export */   "setCharImage": () => (/* binding */ setCharImage)
/* harmony export */ });
...
/* harmony import */ var _loadParticles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./loadParticles */ "./src/js/loadParticles.js");
...
const initializeApp = () => {
	...
	(0,_loadParticles__WEBPACK_IMPORTED_MODULE_3__.initParticles)();
	if (new URLSearchParams(window.location.search).get('shareQuiz')) {
		setTimeout(() => {
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("errorActual").innerText = 'Quiz Copied';
...
window.clickEvents = {
	"btn2": playCode,
	"makebtn": makeCode,
	"signOutbtn": _utils__WEBPACK_IMPORTED_MODULE_1__.signOut,
...
window.keyboardIncludesEvents = {
	...
	"keyboardNavAnswer": (event) => {
		...
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(event.target.id).previousElementSibling.firstElementChild.checked = !(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(event.target.id).previousElementSibling.firstElementChild.checked;
	},
	"keyboardNavTime": (event) => {
		toggleTime(getID(event.target.id));
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(event.target.id).previousElementSibling.firstElementChild.checked = !(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(event.target.id).previousElementSibling.firstElementChild.checked;
	},
	"isCorrectQuestion": (event) => {(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(event.target.id).children[0].checked = !(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(event.target.id).children[0].checked},
...
window.addEventListener('load', () => {
	gapi.load('auth2', function () {
		gapi.auth2.init({
			...
			initializeApp();
			(0,_events__WEBPACK_IMPORTED_MODULE_2__.eventHandle)();
		}
		);
	});
});
...
const login = () => {
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('loginPage').style.display = 'block';
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('loginBtn').disabled = true;
}
...
function userClick(link, disableObject) {
	...
	if (disableObject) {
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(disableObject).disabled = true;
	}
	setTimeout(function () {
...
function onSignIn(googleUser) {
	...
	if (googleUser.getHostedDomain() == 'student.mamkschools.org' || googleUser.getHostedDomain() == 'mamkschools.org') {
		...
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('loginPage').style.animation = 'animatezoomout 0.6s';
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('title').style.top = "15%";
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('title').style.height = "800px";
		setTimeout(function () {
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('loginPage').style.display = "none";
		}, 500);
	} else {
		auth2.signOut();
...
function makeCode() {
	...
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.createTemplate)('svgLoader', makeButton.id);
	// replace this with request to server and await callback or if 5 seconds passes undo
	Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_dragula_dragula_js"), __webpack_require__.e("src_js_make_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./make */ "./src/js/make.js")).then( make => {
		errorCount = 0;
		...
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('charCustomize').classList.add('btnTransitionA');
		setTimeout(function () {
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.setTitle)('makeMenu');
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('title').style.top = '100px';
			addQuiz();
		}, 300);
	}).catch ( error => {
		errorCount++;
		if(errorCount < 15) {
			...
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.throwExcept)('BIG_CHONK4512');
		}
	});
}
...
function playCode() {
	...
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('charCustomize').classList.add('btnTransitionA');
	setTimeout(function () {
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.setTitle)('playMenu');
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('title').style.height = '250px';
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('title').style.top = "30%";
	}, 300);
}
	...
	for (let i = 0; i < contentBoxes.length; i++) {
		if (contentBoxes[i].getAttribute("initialized") != "true") {
			...
			contentBoxes[i].addEventListener('input', (event) => {
				var a69 = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.getCaretCharacterOffsetWithin)(event.target);
				setTimeout(() => {
					...
					try {
						(0,_utils__WEBPACK_IMPORTED_MODULE_1__.setCaretPosition)(event.target, a69);
					}
					catch {
						(0,_utils__WEBPACK_IMPORTED_MODULE_1__.setCaretPosition)(event.target, event.target.innerText.length);
					}
					(0,_utils__WEBPACK_IMPORTED_MODULE_1__.characterCount)(event.target, event.target.getAttribute("maxlength"));
				}, 0);
			});
		}
	}
...
function JoinGame() {
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("gameID").disabled = true;
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("submitID").disabled = true;
	var selects = document.getElementsByTagName("a");
	for (var i = 0, il = selects.length; i < il; i++) {
		selects[i].className += " disabled";
	}
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.clearChildren)('submitID');	
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.createTemplate)('svgLoader', 'submitID');
	if ((0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("gameID").value == "2794") {
		__webpack_require__.e(/*! import() */ "src_js_play_js").then(__webpack_require__.bind(__webpack_require__, /*! ./play */ "./src/js/play.js")).then( play => {
			errorCount = 0;
			Object.entries(play).forEach(([name, exported]) => window[name] = exported);
			setTimeout(function () {
				(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('loader-1').style.display = "none";
				var $loader = document.querySelector(".loader");
				$loader.classList.add('loader--active');
				setTimeout(function () {
					(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("gameStartScreenStudent").style.display = 'block';
				}, 1000);
			}, 750);
			setTimeout(() => {
			...
			if(errorCount < 15) {
				...
				(0,_utils__WEBPACK_IMPORTED_MODULE_1__.throwExcept)('BIG_CHONK4569');
			}
		});
	} else {
		setTimeout(function () {
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("errorActual").textContent = 'Invalid ID';
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("gameID").disabled = false;
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("submitID").disabled = false;
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("errorMessageA").style.display = "block";
			setTimeout(function () {
				(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("errorMessageA").style.display = "none";
			}, 1000);
			...
			(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)('submitID').innerText = 'Join';
		}, 1000);
	}
}
...
function arrowButtonPress(isLeft) {
	...
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("customButtonChange").innerText = customOptions[customOptionsIncrement];
	if(isLeft) {
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("leftCustomizeArrow").focus();
	}
	else {
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)("arrowCustomizeRight").focus();
	}
}
...
function setCharImage(charID, currentUserConfig) {
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(charID + 'Eyes').src = `img/eyes-${currentUserConfig[0]}.png`;
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(charID + 'Nose').src = `img/nose-${currentUserConfig[1]}.png`;
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(charID + 'Mouth').src = `img/mouth-${currentUserConfig[2]}.png`;
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(charID + 'Shirt').src = `img/shirt-${currentUserConfig[3]}.png`;
	(0,_utils__WEBPACK_IMPORTED_MODULE_1__.$)(charID + 'Arms').src = `img/arms-${currentUserConfig[4]}.png`;
}

window.addEventListener("error", (e) => {
	if(e.hasOwnProperty('details')) {
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.throwExcept)('GAPI_ERROR');
	}
	else if (e.message.includes('Script error') || e.message.includes('TypeError')) {
		(0,_utils__WEBPACK_IMPORTED_MODULE_1__.throwExcept)('MISTAKE');
	}
	else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "eventHandle": () => (/* binding */ eventHandle)
/* harmony export */ });
...
/* harmony export */   "getCaretCharacterOffsetWithin": () => (/* binding */ getCaretCharacterOffsetWithin),
...
/* harmony export */   "throwExcept": () => (/* binding */ throwExcept),
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "mamklearn:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmamklearn"] = self["webpackChunkmamklearn"] || [];
...
/******/ 	__webpack_require__("./src/js/events.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/loadParticles.js");
/******/ 	
/******/ })()
;