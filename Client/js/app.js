...
var currentQuizEdit;
var drake = null;
var quizStartTestCase = ' {"gameStart": true, "competitors": ["Nabeel", "Nabeel2", "Nabeel3", "Nabeel4", "Nabeel5"], "competitorConfigs": [[0,0,8,4,2], [0,0,8,4,2], [0,0,8,4,2], [0,0,8,4,2], [0,0,8,4,2]], "totalQuestions": 15, "currentQuestion": "If%20fish%20are%20fish", "choices": [ "fish", "notFish", "fish%20are%20cool", null ], "currentQuestionTime": 69, "questionID": 0 }';
...
function studentGameProcessor(input) {
	...
	if(inputInternal.hasOwnProperty('gameStart')) {
		if(inputInternal.gameStart == true) {
			...
			document.getElementById('studentQuizButton1').firstElementChild.innerText = decodeURI(gameStateStudent.currentQuestionData.answers[0]);
			document.getElementById('studentQuizButton2').firstElementChild.innerText = decodeURI(gameStateStudent.currentQuestionData.answers[1]);
			document.getElementById('studentQuizButton3').firstElementChild.innerText = decodeURI(gameStateStudent.currentQuestionData.answers[2]);
			document.getElementById('studentQuizButton4').firstElementChild.innerText = decodeURI(gameStateStudent.currentQuestionData.answers[3]);
			setTimeout(() => {
				document.getElementById('loader-1').style.display = "none";
				document.getElementById("errorMessageA").style.display = "none";
			}, 1000);
